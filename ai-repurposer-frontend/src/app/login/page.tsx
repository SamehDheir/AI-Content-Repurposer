...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0e0e10] flex items-center justify-center p-4 relative overflow-hidden">
      <main className="w-full max-w-sm" role="main" aria-label="Login form">
      ...
      <div className="relative w-full max-w-sm">
        ...
        <div className="flex flex-col items-center mb-8">
          <div className="w-11 h-11 rounded-2xl bg-indigo-600 flex items-center justify-center shadow-2xl shadow-indigo-500/30 mb-4" aria-hidden="true">
        ...
        <div className="rounded-2xl border border-white/10 bg-zinc-900 p-6 shadow-2xl">
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <button
              ...
              className="w-full py-2.5 rounded-xl bg-white hover:bg-gray-100 text-gray-900 text-sm font-semibold transition-all border border-white/10 flex items-center justify-center gap-2"
        ...
        <p className="text-center mt-4 text-xs text-zinc-600">
          ...
          <button
            ...
            aria-label={isRegister ? "Switch to sign in" : "Switch to sign up"}
          >
